  ...
  menu: [
    {
      ...
      icon: FolderCopy,
      path: "projects",
      component: lazy(() => import("./src/components/shared/Projects")),
    },
    {
      label: "Employees",
      icon: PeopleOutline,
      path: "employees",
      component: lazy(() => import("./src/screens/admin/Employees/Employees")),
      submenu: [
        {
          ...
          component: lazy(() =>
            import("./src/screens/admin/Employees/Register/RegisterEmp")
          ),
        },
        {
          label: "Employee Logs",
          ...
          path: "employees/logs",
          component: lazy(() =>
            import("./src/screens/admin/Employees/EmpLogs/EmployeeLogs")
          ),
        },
      ],
    },
    {
      ...
      icon: Groups,
      path: "dev",
      component: lazy(() => import("./src/screens/developer/AboutDev")),
    },
    {
      label: "About Syncora",
      icon: Favorite,
      path: "about",
      component: lazy(() => import("./src/screens/admin/About/AboutProject")),
    },
  ],
};
...
export const manager = {
  ...
  menu: [
    ...
    },
    {
      ...
      icon: Groups,
      path: "team",
      component: lazy(() => import("./src/screens/manager/Team/MgrTeam")),
    },
    {
      label: "Dashboard",
      icon: Dashboard,
      path: "dashboard",
      component: lazy(() => import("./src/components/shared/Dashboard")),
    },
    {
      label: "Backlog",
      icon: PendingActions,
      path: "backlog",
      component: lazy(() => import("./src/screens/manager/Backlog/MgrBacklog")),
    },
    ...
    // {label:'Report', icon: PieChart, path: 'report', component: lazy(()=> import('./src/screens/manager/Report/MgrReport'))},
    {
      ...
      icon: Timelapse,
      path: "sprints",
      component: lazy(() => import("./src/components/shared/Sprints")),
    },
    {
      label: "Calendar",
