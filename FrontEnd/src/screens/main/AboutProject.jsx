      ...
      <Container fluid>
        <Row className="align-items-center justify-content-between">
          ...
          <Col xs="auto" className="d-flex align-items-center">
            ...
            <Button variant="dark" className="rounded-1 px-4" onClick={() => navigate("/register")}>
              Get Started
            </Button>
          </Col>
        </Row>
...
function TopComponent({head , bgColor , description , btnText , marginTop , paadingTop ,btnRedirect , pBottom}) {
  const navigate = useNavigate();
  return (
    <div style={{ marginTop: marginTop , backgroundColor: bgColor || "white"  ,color: bgColor ? "white" : "black" }}>
      <Container className="mt-5">
        <Row className="justify-content-center text-center" style={{ paddingTop: paadingTop || "0" , paddingBottom: pBottom || "0" }}>
          <Col xs={12} md={8} lg={6}>
            <h1 className="mb-3">
             {head}
            </h1>
  ...
  return (
     <Col>
              ...
              <Card className="border-1 shadow-sm rounded-1">
                <Card.Body>
                  <Card.Title className="text-dark mb-2 fs-6">
                   {title}
                  </Card.Title>
    ...
    <div style={{ marginBottom: "1%" }}>
      <div className="p-2">
        ...
        <TopComponent 
          ...
          description={"Syncora is a lightweight, minimal alternative to Jira — made for startups who want clarity, not complexity. Fast to onboard. Simple to use. Powerful where it matters."} 
      ...
      <div  style={{paddingTop:'1rem'}}> 
         <TopComponent 
          ...
          description={"Join hundreds of startups who've ditched complexity for clarity. Start your free trial today."} 
          bgColor={"black"}
          marginTop={"-4%"}
          paadingTop={"2%"}
          pBottom={"2%"}
