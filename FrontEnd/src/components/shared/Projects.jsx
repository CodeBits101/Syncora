...
import {
  Box, Card, Divider, IconButton, Badge, CardContent, CardMedia, Typography,
  CardActionArea, Paper, Table, TableBody, TableCell, TableContainer, TableHead,
  TablePagination, TableRow, ThemeProvider, createTheme, Tooltip, Button, CircularProgress
} from '@mui/material';
...
const projectTypes = [
  { id: 1, title: "In Progress", summary: "Projects are under Development phase", iconColor: "primary", path: "inprogress", status: "INPROGRESS" },
  { id: 2, title: "Closed", summary: "Projects are closed due to certain reasons", iconColor: "warning", path: "closed", status: "CLOSED" },
  { id: 3, title: "Completed", summary: "Projects are completed successfully.", iconColor: "success", path: "completed", status: "COMPLETED" },
  { id: 4, title: "On Hold", summary: "Projects are currently paused.", iconColor: "error", path: "onhold", status: "HOLD" },
  { id: 5, title: "ReOpen", summary: "Projects which are reopened for development", iconColor: "secondary", path: "reopen", status: "REOPEN" },
];
          ...
          {projectTypes.map((project) => (
            <Card key={project.id} sx={{ minWidth: 200, flexShrink: 0 }}>
              <CardActionArea>
                ...
                >
                  <StyledBadge badgeContent={getCountForStatus(project.status)} color="default" showZero>
                    ...
                    {columns.map((column) => {
                      ...
                      return (
                        <TableCell key={column.id} align={column.align}>
                          {['startDate', 'endDate', 'createdTimeStamp', 'updatedTimeStamp'].includes(column.id)
                            ? formatDate(value)
                            : value}
                        </TableCell>
                      );
